...
if (page =='PENGENCERAN DALAM TITRIMETRI'):
    ...
    with tab1:
        ...
        if (page =='standardisasi NaOH'):
            ...
            st.write ('''
                  1. setelah menghitung berapa voume pengenceran yang dibuat, lakukan lah pengenceran dengan NaOH pekat 
                  2. masukan volume yang di dapat dari hasil pengenceran kedalam gelas piala atau labu takar
        ...
        if (page =='standardisasi KMnO4'):
            ...
            st.write ('''
                  1. setelah menghitung berapa voume pengenceran yang dibuat, lakukan lah pengenceran dengan KMnO4 pekat 
                  2. masukan volume yang di dapat dari hasil pengenceran kedalam gelas piala atau labu takar
        ...
        if (page =='standardisasi TioSulfat'):
            ...
            st.write ('''
                  1. setelah menghitung berapa voume pengenceran yang dibuat, lakukan lah pengenceran dengan TioSulfat pekat 
                  2. masukan volume yang di dapat dari hasil pengenceran kedalam gelas piala atau labu takar
        ...
        if (page =='standardisasi EDTA'):
            ...
            st.write ('''
                  1. setelah menghitung berapa voume pengenceran yang dibuat, lakukan lah pengenceran dengan EDTA pekat 
                  2. masukan volume yang di dapat dari hasil pengenceran kedalam gelas piala atau labu takar
